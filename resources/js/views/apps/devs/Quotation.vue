<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to Create an Quotation</h1>
    ...
    <div class="video-section" ref="videoSection" v-intersect="handleVideoIntersect">
      ...
      <transition name="reveal">
        <div class="video-container" v-if="videoVisible">
          <iframe
            src="https://www.youtube.com/embed/gXP4lUA_cWM?autoplay=0&controls=1"
            frameborder="0"
            allowfullscreen
            class="video-frame"
          ></iframe>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
        title: "Initiate Quotation Generation",
        image: "/images/quotation2.webp",
        details: [
          "Upon a successful inquiry placement, designated admins or authorized employees can generate a quotation.",
          "The system automatically pulls in essential inquiry details to pre-fill the quotation.",
          "This process ensures that the generated quote accurately reflects the customer’s requirements.",
          "Rapid initiation minimizes manual errors and sets a professional tone for the sales process."
        ],
        tip: "Use the search function to quickly find specific inquiries by keyword, client name, or ID."
      },
      {
        title: "Complete Quotation Details and Notify",
        image: "/images/quotation2.webp",
        details: [
          "Users fill in all mandatory fields in the quotation form, including product specifications, pricing details, and any discounts.",
          "Once the form is completed, the system finalizes the quotation.",
          "An automated email and an in-app push notification are immediately sent to the customer.",
          "This ensures timely communication and reinforces transparency throughout the process."
        ],
        tip: "Be as specific as possible when describing your Quotation requirements to receive more accurate responses."
      }
    ]);
