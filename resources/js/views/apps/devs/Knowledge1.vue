<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to add Article in Knowledge Center</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
        title: "Access Featured Articles & Trending Topics",
        image: "/images/kc11.webp",
        details: [
          "The Knowledge Center displays a curated selection of featured articles covering the latest industry trends.",
          "Trending topics are highlighted to provide quick insights into current market movements and best practices.",
          "This section is designed to offer a snapshot of high-value content, ensuring that you stay updated with the most relevant information.",
          "Easy navigation allows you to quickly browse and read the articles that capture your interest."
        ],
        tip: "Bookmark or save your favorite articles for future reference to stay on top of industry trends."
      },
      {
        title: "Explore All Articles for Expert Insights",
        image: "/images/kc22.webp",
        details: [
          "Use the 'Add Article' feature to contribute new insights or update existing content within the Knowledge Center",
          "Navigate to the All Articles section to access a comprehensive library of industry knowledge shared by experts.",
          "The extensive repository is organized by topics and tags, making it easy to search and filter content based on your needs.",
          "This centralized collection of articles ensures that you can continuously learn from and leverage expert advice to inform your strategies."
        ],
        tip: "Use the search and filtering options to quickly locate articles relevant to your current challenges or interests."
      }
    ]);
