    ...
    const steps = ref([
      {
          ...
          image: "/images/uquotation1.webp",
          details: [
            "Once the admin reviews your inquiry and sends a quotation, you'll receive a notification on your dashboard.",
            "Navigate to the Inquiry section where you can view the detailed quotation.",
            "Review the quotation thoroughly to ensure it meets your requirements.",
            "Click the Confirm order button if everything is in order to confirm the quotation."
          ],
          tip: "Double-check all details before approving to ensure the quotation accurately reflects your needs, as this action finalizes the transition from inquiry to order."
        },
    ]);
