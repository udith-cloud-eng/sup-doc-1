<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to Create a Job Card</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
          title: "Assign Job Cards to Staff Members",
          image: "/images/job-card.webp",
          details: [
            "Admins can create digital job cards containing task details, deadlines, and priority levels.",
            "Each job card is assigned to a specific staff member based on their role and expertise.",
            "Staff members receive real-time notifications upon job card assignment, ensuring immediate task awareness.",
            "This structured assignment system helps streamline work allocation and improve task management efficiency."
          ],
          tip: "Clearly define task objectives and expectations in the job card to prevent confusion and enhance productivity."
        },
    ]);
