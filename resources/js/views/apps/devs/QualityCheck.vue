<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to do Quality Check</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
          title: "Conduct a Thorough Quality Check",
          image: "/images/qc1.webp",
          details: [
            "Once production is finished, initiate the Quality Check process to inspect each product carefully.",
            "Evaluate each item against established quality standards and specifications to ensure compliance.",
            "Document any discrepancies or issues identified during the inspection for further review.",
            "Confirm that every product meets the necessary quality criteria before proceeding to the next stage."
          ],
          tip: "Use a standardized inspection checklist to ensure consistency across all quality checks and to catch any minor defects early on."
        }
    ]);
