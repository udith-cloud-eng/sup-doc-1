<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">Knowledge Center</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
        id: 1,
        title: "Browse Technology & Product Articles",
        image: "/images/ukc1.webp",
        description: `The Knowledge Center allows customers to explore in-depth insights into the latest technologies and products offered on the platform. This feature serves as a valuable resource, providing informative articles, industry trends, and expert analyses to help you stay updated and make informed decisions`,
        bulletPoints: [
          "Customers can access a curated collection of articles related to technology, manufacturing, and industry trends.",
          "These articles provide detailed insights into the products and services available, helping you understand their applications and benefits.",
          "The Knowledge Center is regularly updated with fresh content, ensuring that you always have access to the latest innovations.",
          "Easily search and filter articles based on categories or topics of interest."
        ],
        tip: "Use the search function to quickly find articles relevant to your industry or specific needs."
      },
    ]);
