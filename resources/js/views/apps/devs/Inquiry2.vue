<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to Create an Inquiry</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
        title: "Access Inquiry Section",
        image: "/images/inquiry1.webp",
        details: [
          "Navigate to the 'Inquiries' tab in the sidebar menu",
          "View all existing inquiries in a sortable table format",
          "Access inquiry management tools and filters",
          "Monitor real-time status updates of ongoing inquiries"
        ],
        tip: "Use the search function to quickly find specific inquiries by keyword, client name, or ID."
      },
      {
        title: "Complete Form Details",
        image: "/images/inquiry2.webp",
        details: [
          "Click the 'New Inquiry' button to open the form",
          "Fill in all required fields marked with an asterisk (*)",
          "Upload relevant documents and reference materials",
          "Select appropriate inquiry categories and priority levels"
        ],
        tip: "Be as specific as possible when describing your inquiry requirements to receive more accurate responses."
      },
      {
        title: "Review and Submit",
        image: "/images/inquiry3.webp",
        details: [
          "Double-check all entered information for accuracy",
          "Ensure all required documents are properly attached",
          "Verify contact information is correct for follow-ups",
          "Click 'Submit' to finalize and register your inquiry"
        ],
        tip: "Save drafts of complex inquiries to complete later if you need more time to gather information."
      },
      {
        title: "Track Progress",
        image: "/images/inquiry4.webp",
        details: [
          "View inquiry status in the dashboard table",
          "Receive email notifications for status updates",
          "Access detailed inquiry history and communication logs",
          "Filter and sort inquiries by status, date, or priority"
        ],
        tip: "Use the built-in commenting system to provide additional information without creating new inquiries."
      }
    ]);
