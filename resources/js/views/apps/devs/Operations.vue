<template>
  <div class="onboarding-container">
    <header class="header-section">
      <h1 class="main-heading">How to create Operation</h1>
...
export default defineComponent({
  ...
  setup() {
    const steps = ref([
      {
        title: "Define Operations & Customize Attributes",
        image: "/images/operation1.webp",
        details: [
          "Identify and outline the key operations integral to your production process.",
          "Add specific attributes to each operation for better customization, such as duration, required resources, and quality standards.",
          "Organize the operations logically to mirror the actual production workflow, ensuring smooth transitions between steps.",
          "Use these defined operations as the foundation for planning and scheduling your production activities."
        ],
        tip: "Clearly document each operation along with its attributes to facilitate consistent execution and easier future adjustments."
      },
      {
        title: "Update and Edit Operations",
        image: "/images/obp3.webp",
        details: [
          "Access the operation management interface using the designated action button.",
          "Make real-time modifications to any operation details as your production requirements evolve.",
          "Update attributes, adjust sequencing, or add new information with just a click for quick revisions.",
          "Confirm and save all changes to ensure that the updated operations align with your current production strategy."
        ],
        tip: "Regularly review and refine your operations to maintain process accuracy and optimize overall production efficiency."
      }
    ]);
